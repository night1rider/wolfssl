 ...
 * AES-ECB offload (128/256 bit keys). Other modes and AES-192 use software. */
...
/* Single entry point for the cipher engine. The crypto callback dispatcher
 * routes cipher operations here; returns 0 on success, CRYPTOCB_UNAVAILABLE for
 * an unsupported mode/key (software fallback), or a negative error. */
